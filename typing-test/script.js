...
const text =
    'Keeb, short for "keyboard," refers to the world of mechanical keyboards. In this collection, you will find a diverse array of builds, each showcasing the creativity and individuality of the community. From sleek and minimalistic to bold and unconventional, this collection celebrates the variety and creativity within the keeb community.';
